...
`agents/cloak-sting-agent.mjs` wraps the existing sting scam-detection pipeline as an Agentverse-compatible agent. It exposes four HTTP routes that other agents or orchestrators can call to analyze threats.
