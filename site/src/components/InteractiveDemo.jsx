...
function RiskMeter({ score }) {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <motion.span
        className="font-mono text-xl font-bold text-text-primary tabular-nums"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
                ...
                {scanning && (
                  ...
                  >
                    <div className="flex flex-col items-center gap-5">
                      ...
                      >
                        <Loader2 size={24} className="text-honey/80" strokeWidth={1.5} />
                      </motion.div>
                      <p className="text-[14px] font-medium text-text-secondary">
                        Analyzing signals...
                      </p>
                      <div className="relative h-px w-48 overflow-hidden rounded-full bg-white/[0.04]">
                        <motion.div
                          className="absolute inset-0 h-full w-1/3 rounded-full bg-gradient-to-r from-transparent via-honey/60 to-transparent"
                          animate={{ x: ["-100%", "400%"] }}
